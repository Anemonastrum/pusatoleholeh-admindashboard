...
function DropdownProfile({
  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        <img className="w-8 h-8 rounded-full" src="/images/Hydro.svg" width="32" height="32" alt="User" />
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-sm font-medium text-gray-600 dark:text-gray-100 group-hover:text-gray-800 dark:group-hover:text-white">Mr Wilo</span>
      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
            <div className="font-medium text-gray-800 dark:text-gray-100">Mr Wilo</div>
